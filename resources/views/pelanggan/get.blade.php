                            ...
                            <form class="form-horizontal" action="" id="form_validation" method="post">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4 col-sm-3 col-xs-5 form-control-label">
                                        <label for="nmpelanggan">Nama/Instansi</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nmpelanggan" class="form-control" placeholder="Nama/Instansi" value="{{ $pelanggan->nmpelanggan }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="telepon" class="form-control" placeholder="Telepon" value="{{ $pelanggan->telepon }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
