                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nmpelanggan" class="form-control" placeholder="Nama/Instansi" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover table-pelanggan dataTable display responsive no-wrap" width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nama</th>
