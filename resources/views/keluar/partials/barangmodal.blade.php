        ...
        <div class="modal-content">
            <form class="form-horizontal" id="formDetail" action="" method="post">
                ...
                <div class="modal-body">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="">
                                    <select class="form-control kode-barang" name="barang_kode" required>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="stokkeluar" id="stokkeluar" onchange="kurangstok()" class="form-control" value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
                            <label for="stokakhir">Stok Sisa</label>
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="harga" id="harga" class="form-control" onchange="hitungharga()" value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="addDetail" class="btn btn-link waves-effect">TAMBAH</button>
