                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{ route('lihatKeluar') }}">Lihat Barang Keluar</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <form class="form-horizontal" action="" id="form_validation" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="pemesan" class="form-control" value="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tglkeluar" class="form-control datepicker" value="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
