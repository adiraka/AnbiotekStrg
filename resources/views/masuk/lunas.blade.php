                            ...
                            <form class="form-horizontal" action="" id="form_validation" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nobon" class="form-control" placeholder="Nomor Faktur" value="{{ $masuk->nobon }}" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="">
                                                <select class="form-control status" id="status" name="status" required>
                                                    <option value="{{ $masuk->status }}" selected>{{ $masuk->status }}</option>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="tgllunas" name="tgllunas" class="form-control datepicker" placeholder="Tanggal Pelunasan" value="{{ $masuk->tgllunas }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
