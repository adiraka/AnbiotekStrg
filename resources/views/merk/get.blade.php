                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form class="form-horizontal" action="" id="form_validation" method="post">
                                ...
                                <input type="hidden" name="idmerk" value="{{ $merk->id }}">
                                <input type="hidden" name="_method" value="PUT">
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4 col-sm-3 col-xs-5 form-control-label">
                                        <label for="nmkategori">Nama Merk</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nmmerk" class="form-control" value="{{ $merk->nmmerk }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-3 col-xs-offset-5">
                                        ...
                                        <a href="{{ route('tambahMerk') }}" class="btn btn-default m-t-15 waves-effect">Batal</a>
                                    </div>
                                </div>
                            </form>
                        </div>
